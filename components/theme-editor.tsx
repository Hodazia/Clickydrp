...
export default function ThemeEditor() {
  ...
  const previewStyle = useMemo<React.CSSProperties>(() => {
    ...
    if (theme.viewportType === 'gradient' && theme.viewportGradient) {
      return { background: theme.viewportGradient }
    }
  ...
  const Section = ({ children, title, isOpen = true, onToggle, icon }:
    { children: React.ReactNode; title: string; isOpen?: boolean; onToggle?: () => void; icon?: React.ReactNode, }) => (
    <Card className="glass-card bg-white border-accent/20 border-ring-1 shadow-md border-1 border-indigo-200 dark:bg-[#0f0f0f]">
      <CardContent className="p-4 md:p-2">
        ...
        {isOpen && (<div className="grid gap-4 mt-4">{children}</div>)}
      </CardContent>
    </Card>
  )
  ...
  const SocialIcons: Record<string, (props: React.SVGProps<SVGSVGElement>) => React.ReactElement> = {
    ...
    twitter: (props) => (<svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M22.46 6c-.77.35-1.6.58-2.46.69a4.28 4.28 0 001.88-2.37 8.56 8.56 0 01-2.71 1.04 4.27 4.27 0 00-7.27 3.9A12.12 12.12 0 013 4.9a4.26 4.26 0 001.32 5.69 4.23 4.23 0 01-1.93-.53v.05a4.27 4.27 0 003.43 4.18 4.24 4.24 0 01-1.92.07 4.27 4.27 0 003.98 2.96A8.56 8.56 0 012 19.54a12.08 12.08 0 006.56 1.92c7.88 0 12.2-6.53 12.2-12.2 0-.19-.01-.39-.02-.58A8.7 8.7 0 0024 5.5a8.49 8.49 0 01-2.54.7z"/></svg>),
    tiktok: (props) => (<svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64c.3.08.6.13.88.13V9.4c-.33-.03-.67-.05-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4c-.34-.03-.67-.07-1-.1z"/></svg>),
    youtube: (props) => (<svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M23.5 6.19a3.02 3.02 0 00-2.12-2.14C19.51 3.55 12 3.55 12 3.55s-7.51 0-9.38.5A3.02 3.02 0 00.5 6.19C0 8.07 0 12 0 12s0 3.93.5 5.81c.28 1.02 1.1 1.84 2.12 2.14 1.87.5 9.38.5 9.38.5s7.51 0 9.38-.5a3.02 3.02 0 002.12-2.14C24 15.93 24 12 24 12s0-3.93-.5-5.81zM9.55 15.57V8.43L15.82 12l-6.27 3.57z"/></svg>),
    linkedin: (props) => (<svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M4.98 3.5C4.98 4.88 3.86 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM0 8h5v16H0V8zm7.5 0H12v2.2h.06c.63-1.18 2.17-2.42 4.47-2.42 4.79 0 5.67 3.15 5.67 7.25V24h-5V16c0-1.9-.03-4.34-2.64-4.34-2.64 0-3.05 2.06-3.05 4.2V24h-5V8z"/></svg>),
    facebook: (props) => (<svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M22.675 0h-21.35C.595 0 0 .594 0 1.326v21.348C0 23.405.595 24 1.325 24H12.82v-9.294H9.692V11.41h3.127V8.797c0-3.1 1.894-4.788 4.66-4.788 1.325 0 2.463.099 2.795.143v3.24h-1.918c-1.504 0-1.796.715-1.796 1.765v2.313h3.592l-.468 3.296h-3.124V24h6.127C23.406 24 24 23.405 24 22.674V1.326C24 .594 23.406 0 22.675 0z"/></svg>),
    reddit: (props) => (<svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 0a12 12 0 100 24 12 12 0 000-24zm5.01 4.74a1.25 1.25 0 110 2.5 1.25 1.25 0 010-2.5z"/></svg>),
    pinterest: (props) => (<svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 4.9 3.05 9.07 7.36 10.78-.1-.86-.19-2.18.04-3.13.21-.85 1.35-5.4 1.35-5.4s-.34-.65-.34-1.61c0-1.5.87-2.62 1.96-2.62.9 0 1.34.67 1.34 1.47 0 .9-.57 2.24-.87 3.49-.25 1.04.53 1.89 1.56 1.89 1.87 0 3.31-1.97 3.31-4.81 0-2.51-1.8-4.27-4.37-4.27-2.98 0-4.73 2.23-4.73 4.54 0 .9.35 1.86.78 2.38.08.1.09.19.07.3-.08.33-.26 1.05-.3 1.19-.05.2-.15.24-.35.15-1.29-.6-2.1-2.48-2.1-4 0-3.25 2.36-6.24 6.8-6.24 3.57 0 6.35 2.55 6.35 5.94 0 3.54-2.24 6.4-5.36 6.4-1.04 0-2.02-.54-2.35-1.19l-.64 2.44c-.23.89-.86 2-1.28 2.68.97.3 1.99.46 3.05.46 6.62 0 11.99-5.37 11.99-11.99C24.007 5.367 18.64 0 12.017 0z"/></svg>),
  }
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-12">
            ...
            <>
              <div className='dark:text-white '>
                ...
                <select
                  ...
                  className="mt-1 min-w-0 w-full rounded-md border-2 border-indigo-200 hover:border-ring-2 p-2"
                >
                ...
                <div className='dark:text-white '>
                  ...
                  <div className="mt-1 flex items-center gap-3">
                    ...
                    <Input
                      ...
                      className='min-w-0 w-full border-2 border-indigo-200 hover:border-ring-2'
                      onChange={(e) => setTheme((v) => ({ ...v, viewportColor: e.target.value }))}
                    />
                  </div>
                </div>
              ...
              {theme.viewportType === 'gradient' && (
                <div className='dark:text-white'>
                  ...
                  <Input
                    ...
                    className='min-w-0 w-full border-2 border-indigo-200 hover:border-ring-2 dark:text-white'
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="mt-1 min-w-0 w-full rounded-md border-2 border-indigo-200 hover:border-ring-2 p-1"
                  >
      ...
      <div className="lg:col-span-8 ">
        <Card className="border-accent/20 bg-white border-indigo-600 border-2 border-ring-2 sticky top-6">
          <CardContent className="p-6">
            ...
            <div className="flex items-center justify-center">
              {(!data) ? (
                ...
                /* Responsive phone frame (clipped content) */
                <div className="relative w-full max-w-[360px] aspect-[9/18] rounded-[2.5rem] border-[10px] border-black/90 shadow-2xl overflow-hidden bg-black/5">
                  <div className="absolute inset-[10px] rounded-[2rem] overflow-hidden flex flex-col">
                    <div
                    ...
                    <div className="relative h-full w-full overflow-y-auto bg-transparent">
                      <div className="min-h-full w-full px-4 py-5 flex flex-col items-center pb-24">
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            >
                              <Image
                                src={data?.profileimg}
                                alt="Profile Image"
                                className={`object-cover w-full h-full ${theme.profileShape === 'circle' ? 'rounded-full' : theme.profileShape === 'rounded' ? 'rounded-lg' : ''}`}
                                width={80}
                                height={80}
                              />
                            </div>

                            <h4 className="mt-3 font-semibold" style={{ color: theme.bioFontColor || '#111827' }}>
                              @{data?.username}
                            </h4>
                            <p className="text-center text-sm mt-1" style={{ color: theme.bioFontColor || '#111827', fontSize: (theme.bioFontSize || 16) + 'px' }}>
                              {data?.description}
                            </p>
                            ...
                            {data?.socials && data.socials.length > 0 && (
                              <div className="mt-4 flex items-center gap-3">
                                {data.socials.map((s, idx) => {
                                  ...
                                  return (
                                    <Link key={s.platform + idx} href={s.url} target="_blank" rel="noopener noreferrer" onMouseEnter={() => setHoveredSocialIdx(idx)} onMouseLeave={() => setHoveredSocialIdx(null)} className="inline-flex" aria-label={s.platform}>
                            ...
                            {/* Links - neo-brutal preview (clipped inside phone) */}
                            <div className="w-full mt-4 space-y-3">
                              {data?.links?.map((i, idx) => (
                                <Link
                                  ...
                                  className="block overflow-hidden rounded-xl nb-shadow"
                                  style={{ textDecoration: 'none' }}
                                >
                                  <div
                                    className="w-full flex items-center gap-3 h-12 p-3 font-medium transition-colors"
                                    style={{
                                      ...
                                      boxShadow: '0 2px 0 rgba(0,0,0,0.85)',
                                      boxSizing: 'border-box',
                                    }}
                                  >
                                    <div className="w-10 h-10 rounded-md overflow-hidden bg-gray-200 flex-shrink-0" >
                                      {i.linkThumbnail ? (
                                        <Image src={i.linkThumbnail} alt="Link Thumbnail" className="w-full h-full object-cover" width={40} height={40} />
                                      ) : null}
                                    </div>
                            ...
                            {/* CTA - sticky inside scrollable area so it never escapes the phone */}
                            <div className="w-full flex justify-center items-center sticky bottom-4 z-10 mt-6">
                              <Link
                                href="/signin"
                                className="text-white px-2 py-2 rounded-full border-2  nb-shadow
                              ...
                              >
                                ...
                                <Image src={logo} alt="logobutton" className="w-6 h-6" width={24} height={24} />
                              </Link>
                            </div>
